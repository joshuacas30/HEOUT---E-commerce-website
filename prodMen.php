...
<body>
    ...
    <nav>
      ...
      <div class="menu-right">
        ...
        <div class="dropdown">
          <button class="btn " type="button" id="dropdownMenuButton" data-mdb-toggle="dropdown" aria-expanded="false"
            ><i class='bx bx-user bx-tada-hover bx-sm'></i></button>
            <ul class="dropdown-menu dropdown-menu-end">
            <span style="margin-left: 8px; flex-wrap; wrap;">Welcome,<?php echo $username; ?></span>
                <li> <?php if (isset($_SESSION['customerID'])) : ?>

                      <a href="./php/signout.php" style="margin-left: 8px;">Logout</a>
                  <?php else : ?>
        ...
        if (isset($_SESSION['customerID'])) {
            ...
            if ($selectCart->rowCount() > 0) {
                ...
                while ($row = $selectCart->fetch()) {
                    ...
                    echo '</div>';
                    echo '<button type="button" class="btn  btn-md" name="remove-item" style="color: red;" >Remove</button>';
                    echo '</div>';
                }
            } else {
